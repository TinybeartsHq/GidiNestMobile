...
> = {
  phone: {
    ...
    gradient: ['rgba(123,97,255,0.24)', 'rgba(123,97,255,0.05)'],
    tip: 'Your mobile number becomes your primary login identity.',
    helper: 'Reachable mobile numbers keep your savings journey secure.',
  },
  otp: {
    tag: 'Step 2 · Confirm',
    icon: 'shield-key',
    gradient: ['rgba(112,207,255,0.22)', 'rgba(112,207,255,0.05)'],
    tip: 'Security codes expire quickly—enter it as soon as it drops in.',
    helper: 'Didn’t receive a code? Request another after 30 seconds.',
  },
  profile: {
    tag: 'Step 3 · Personalise',
    icon: 'account-heart',
    gradient: ['rgba(120,202,190,0.22)', 'rgba(120,202,190,0.05)'],
    tip: 'We tailor goals and nudges based on your profile details.',
    helper: 'Ensure names match your identification for seamless KYC.',
  },
  password: {
    tag: 'Step 4 · Secure',
    icon: 'lock-check',
    gradient: ['rgba(255,166,158,0.22)', 'rgba(255,166,158,0.05)'],
    tip: 'Pick a strong password you can remember without writing down.',
    helper: 'Add capital letters, numbers, and symbols to strengthen it.',
  },
};
